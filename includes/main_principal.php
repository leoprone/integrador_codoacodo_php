...
<?php
        #BOTÓN para que CUALQUIER visitante no registrado pueda ver TODOS los ORADORES -->
...
<!--......................................enlaces a CRUD que solo puede ver el ADMINISTRADOR........................................................-->
        ...
        <?php 
          ...
          if ( isset( $_SESSION['usuario']) and $_SESSION['administrador']=='s') {
         #crud ORADORES
        ?>
...
<!-- 
 ...
 <section id="lugarFecha" class="lugarFecha">
            <div class="lugarFecha__divImg">
                <img class="divImg__img" src="./assets/img/honolulu-min.jpg" width="600px" loading="lazy" alt="Mar del Plata">
            </div>
  ...
  <?php
          ...
          */
          if ( isset( $_SESSION['usuario']) and $_SESSION['logueado']='s') {
